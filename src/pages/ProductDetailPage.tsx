...
import { useSubscribeNotificationMutation } from '../services/apis/userApi';
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {productData?.auctionFormat === 'buy-it-now' ? (
                ...
                <button onClick={()=>navigate(`/auction-page/${productData?._id}`)} className="w-full bg-amber-500 border-amber-300 text-white py-2 rounded hover:bg-amber-700 transition duration-300">
                  Enter Bid{' '}
                </button>
              )}
