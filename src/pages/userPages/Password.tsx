...
const UserProfile: React.FC = () => {
  ...
  return (
   ...
   <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam nulla dolorum laudantium quis molestias earum asperiores vel ab totam? Possimus maiores molestias quia numquam perferendis, delectus vitae est nesciunt ducimus?</p>
   </div>
   </section>
  );
};
